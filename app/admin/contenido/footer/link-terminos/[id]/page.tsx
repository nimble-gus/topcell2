...
export default function EditarLinkTerminosPage() {
    ...
    <div className="mx-auto max-w-2xl">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900">
          {id === "nuevo" ? "Agregar" : "Editar"} Link "Términos y Condiciones"
        </h1>
        <p className="mt-2 text-sm text-gray-600">
          Configura la URL del link "Términos y Condiciones" del footer
        </p>
      </div>
        ...
        <div className="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="https://topcell.com/terminos"
            />
          </div>
        </div>
