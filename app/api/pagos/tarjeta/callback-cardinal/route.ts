 ...
 * Cardinal Commerce intenta hacer un POST directo a /pago/3dsecure/callback desde el iframe
 ...
 * 
 * NOTA: Esta ruta está en /api/pagos/tarjeta/callback-cardinal porque Cardinal Commerce
 * está configurado para hacer POST a /pago/3dsecure/callback, pero Next.js necesita que
 * esa ruta sea un page.tsx para los GETs del flujo normal.
 * 
 * Si Cardinal Commerce hace POST a /pago/3dsecure/callback, Next.js lo tratará como
 * Server Action y fallará. La solución es que Cardinal Commerce use window.postMessage
 * en lugar de POSTs directos (que es el flujo estándar).
 */
