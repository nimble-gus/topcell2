  ...
  const loadData = async () => {
    try {
      ...
      if (response.ok) {
        ...
        const bannerItem = data.find((item: ContenidoItem) => item.tipo === "privacidad-banner");
        const contenidoItem = data.find((item: ContenidoItem) => item.tipo === "privacidad-contenido");
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Gestionar Política de Privacidad</h1>
      </div>
