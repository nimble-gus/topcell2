...
export default function EditarCTAPage() {
  ...
  useEffect(() => {
    async function loadData() {
      try {
        ...
        if (!response.ok) {
          throw new Error("Imagen CTA no encontrada");
        }
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <h1 className="mt-4 text-3xl font-bold text-gray-900">Editar Imagen Publicitaria CTA</h1>
        <p className="mt-2 text-sm text-gray-600">
          Modifica la imagen publicitaria y su enlace de destino
        </p>
      </div>
